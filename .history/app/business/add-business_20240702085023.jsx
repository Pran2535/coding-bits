import { View, Text, Image, TouchableOpacity, TextInput, ScrollView, KeyboardAvoidingView, Platform, ToastAndroid } from 'react-native'
...
const AddBusiness = () => {
  ...
  const onImagePick = async () => {
   ...
   const saveBusinessDetail=async(imageUrl)=>{
     ...
     ToastAndroid.show('New business Added...')
   }
